...
package object streams {
  ...
  /**
   * Create a Pekko Streams source for the given [[Consumer]] that produces [[ConsumerMessage]]s and auto-acknowledges.
   *
  ...
  /**
    * Create a Pekko Streams source for the given [[Reader]] that produces [[ConsumerMessage]]s.
  ...
  /**
   * Create a Pekko Streams source for the given [[Consumer]] that produces [[CommittableMessage]]s, which can be
